...
1. Compute the first 10 samples of the impulse response, using `impz()`,
for the filter designed in the previous exercise. 
   
   Check that the first 5 samples are the same as $h_d[n]$. How about the next ones?
